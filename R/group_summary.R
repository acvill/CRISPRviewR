#' summarize the dataset generated by \code{\link{group_arrays}}
#'
#' Given a dataset created with \code{\link{group_arrays}}, this function lists
#' the samples represented by each consensus repeat, sorted by the
#' number of constituent samples (descending).
#'
#'
#' @param data An object created with \code{\link{group_arrays}}.
