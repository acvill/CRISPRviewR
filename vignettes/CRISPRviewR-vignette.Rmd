...
The `group_arrays()` function determines a consensus repeat for each array,
...
```{r, eval=TRUE, message=FALSE, warning=FALSE, fig.height=1.5}
plot_arrays(group = dplyr::filter(groups, repcon_grp == 66),
            plot_logo = FALSE)
```
